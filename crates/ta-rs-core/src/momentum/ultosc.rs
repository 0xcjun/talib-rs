...
pub fn ultosc(
    ...
    for i in max_period..len {
        let sum_bp1: f64 = bp[(i + 1 - timeperiod1)..=i].iter().sum();
        let sum_tr1: f64 = tr[(i + 1 - timeperiod1)..=i].iter().sum();
        let sum_bp2: f64 = bp[(i + 1 - timeperiod2)..=i].iter().sum();
        let sum_tr2: f64 = tr[(i + 1 - timeperiod2)..=i].iter().sum();
        let sum_bp3: f64 = bp[(i + 1 - timeperiod3)..=i].iter().sum();
        let sum_tr3: f64 = tr[(i + 1 - timeperiod3)..=i].iter().sum();
